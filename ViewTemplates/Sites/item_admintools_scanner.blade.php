...
<div class="row row-cols-lg-auto g-4 align-items-center mb-3 p-2">
    ...
    <div class="col-12">
        <a href="@route(sprintf('index.php?view=scannertasks&site_id=%d&manual=0', $model->getId()))"
    ...
    <div class="col-12">
        <a href="@route(sprintf('index.php?view=site&task=read&id=%d&adminToolsForce=1', $model->getId()))"
