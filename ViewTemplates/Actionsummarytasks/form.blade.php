...
<form action="@route('index.php?view=actionsummarytasks')"
    ...
    <h4>@lang('PANOPTICON_ACTIONSUMMARYTASKS_LBL_OPTIONS')</h4>

    <div class="row mb-3">
        <label for="period"
               class="col-form-label col-sm-3 ">@lang('PANOPTICON_ACTIONSUMMARYTASKS_LBL_PERIOD')</label>
        <div class="col-sm-9">
            {{ $this->container->html->select->genericList(
                data: [
					'daily' => 'PANOPTICON_ACTIONSUMMARYTASKS_LBL_PERIOD_DAILY',
					'weekly' => 'PANOPTICON_ACTIONSUMMARYTASKS_LBL_PERIOD_WEEKLY',
					'monthly' => 'PANOPTICON_ACTIONSUMMARYTASKS_LBL_PERIOD_MONTHLY',
                ],
                name: 'period',
                attribs: [
                    'class' => 'form-select',
                ],
                selected: $params->get('period', 'daily'),
                translate: true
            ) }}

            <div class="form-text">
                @lang('PANOPTICON_ACTIONSUMMARYTASKS_LBL_PERIOD_HELP')
            </div>
        </div>
    </div>
