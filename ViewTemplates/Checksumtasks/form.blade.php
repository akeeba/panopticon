...
<form action="@route('index.php?view=checksumtasks')"
    ...
    <div>
        ...
        <div class="row mb-3">
            <label for="minutes" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_MINUTES')
            </label>
            <div class="col-sm-9">
                ...
                <div class="form-text collapse">
                    @lang('PANOPTICON_CHECKSUMTASKS_LBL_MINUTES_HELP')
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="hours" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_HOURS')
            </label>
            <div class="col-sm-9">
                ...
                >
                <div class="form-text collapse">
                    @lang('PANOPTICON_CHECKSUMTASKS_LBL_HOURS_HELP')
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="dom" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_DOM')
            </label>
            <div class="col-sm-9">
                ...
                >
                <div class="form-text collapse">
                    @lang('PANOPTICON_CHECKSUMTASKS_LBL_DOM_HELP')
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="month" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_MONTH')
            </label>
            <div class="col-sm-9">
                ...
                >
                <div class="form-text collapse">
                    @lang('PANOPTICON_CHECKSUMTASKS_LBL_MONTH_HELP')
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="dow" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_DOW')
            </label>
            <div class="col-sm-9">
                ...
                >
                <div class="form-text collapse">
                    @lang('PANOPTICON_CHECKSUMTASKS_LBL_DOW_HELP')
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="run_once" class="col-sm-3 col-form-label">
                @lang('PANOPTICON_CHECKSUMTASKS_LBL_FIELD_RUN_ONCE')
            </label>
            <div class="col-sm-9">
                {{ $this->container->html->select->genericList(
                    [
						'' => 'PANOPTICON_CHECKSUMTASKS_LBL_FIELD_RUN_ONCE_NONE',
						'disable' => 'PANOPTICON_CHECKSUMTASKS_LBL_FIELD_RUN_ONCE_DISABLE',
						'delete' => 'PANOPTICON_CHECKSUMTASKS_LBL_FIELD_RUN_ONCE_DELETE',
                    ],
                    'params[run_once]',
                    [
                        'class' => 'form-select',
