                                ...
                                <div class="flex-grow-1 d-flex flex-column gap-1">
                                    ...
                                    <div class="d-flex flex-column flex-md-row align-items-center gap-3 text-muted">
                                        <span class="flex-grow-1">
                                            @sprintf('PANOPTICON_MFA_LBL_CREATEDON', \Awf\Html\Html::date($record->created_on, \Awf\Text\Text::_('DATE_FORMAT_LC2')))
                                        </span>
                                        <span class="flex-grow-1">
                                            @sprintf('PANOPTICON_MFA_LBL_LASTUSED', \Awf\Html\Html::date($record->last_used, \Awf\Text\Text::_('DATE_FORMAT_LC2')))
                                        </span>
                                    </div>
                                </div>
