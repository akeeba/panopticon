...
trait EnqueueWordPressUpdateTrait
{
	/**
	 * Enqueues a WordPress site for an automatic update to a newer WordPress version.
	 *
	 ...
	 * @return  void
	 */
	private function enqueueWordPressUpdate(Site $site, Container $container, bool $force = false, ?User $user = null): void
	{
		/** @var Task $task */
