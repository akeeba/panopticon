...
#[AsCommand(
	name: 'task:pluginupdates:director',
	description: 'Enqueue automatic plugin and theme updates for WordPress sites',
	hidden: false,
)]
#[ConfigAssertion(true)]
class TaskPluginUpdatesDirector extends AbstractCommand
{
	...
	protected function execute(InputInterface $input, OutputInterface $output): int
	{
		...
		$callback  = $container->taskRegistry->get('pluginupdatesdirector');
