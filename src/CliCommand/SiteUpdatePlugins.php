...
#[AsCommand(
	name: "site:update:plugins",
	description: "Updates WordPress plugins and themes"
)]
class SiteUpdatePlugins extends AbstractCommand
{
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$callback  = $container->taskRegistry->get('pluginsupdate');
