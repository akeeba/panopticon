...
#[AsCommand(
	name: 'task:wordpressupdate:director',
	description: 'Enqueue automatic core updates and send update emails for WordPress sites',
	hidden: false,
)]
#[ConfigAssertion(true)]
class TaskWordPressUpdateDirector extends AbstractCommand
{
	...
	protected function execute(InputInterface $input, OutputInterface $output): int
	{
		...
		$callback  = $container->taskRegistry->get('wordpressupdatedirector');
