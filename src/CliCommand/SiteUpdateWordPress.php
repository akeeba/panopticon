...
#[AsCommand(
	name: "site:update:wordpress",
	description: "Updates WordPress core"
)]
class SiteUpdateWordPress extends AbstractCommand
{
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$callback  = $container->taskRegistry->get('wordpressupdate');
