...
class Mailtemplates extends DataModel
{
	...
	public static function getMailTypeOptions(): array
	{
		return [
			...
			'jextupdate_found' => 'PANOPTICON_MAILTEMPLATES_OPT_TYPE_JEXTUPDATE_FOUND',
			'jextupdate_installed' => 'PANOPTICON_MAILTEMPLATES_OPT_TYPE_JEXTUPDATE_INSTALLED',
			'jextupdate_failed' => 'PANOPTICON_MAILTEMPLATES_OPT_TYPE_JEXTUPDATE_FAILED',
