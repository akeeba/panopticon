...
<div class="container">
    <p class="info">
        If you have a paid subscription and would like to get help for an error please print the page into a PDF file. Attach the PDF file to your support request. Do remember to tell us exactly what you were doing when the error occurred.
    </p>
</div>
...
<div class="container">
    <div class="sf-tabs">
        ...
        <div class="tab">
            ...
            <div class="tab-content">
                <?= $this->include('error/environment.html.php') ?>
            </div>
        </div>
    </div>
</div>
